...
(function($) {
	...
	function jqTimeLine(element, options) {
		...
		this._max_width = this.options.max_width;
	...
	jqTimeLine.prototype._generateMarkup = function() {
		...
		if(this._max_width && this._max_width >= 0) {
			var totalWidth = this._max_width + 3;
			this._gap = this._max_width / (_this.options.numYears * 12.0);
			var containerWidth = totalWidth + 30;
		}
