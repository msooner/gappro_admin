...
(function () {
    ...
    function UIManager(postfix, panels, undoManager, previewManager, commandManager, helpOptions) {
        ...
        function makeSpritedButtonRow() {
            ...
            group1 = makeGroup(1);
            buttons.bold = makeButton("bme-bold-button", "<i class='icon-bold'></li>", "Bold - Ctrl+B", "icon-bold", bindCommand("doBold"), group1);
            buttons.italic = makeButton("bme-italic-button", "<i class='icon-italic'></i>", "Italic - Ctrl+I", "icon-italic", bindCommand("doItalic"), group1);
            
            group2 = makeGroup(2);
            buttons.link = makeButton("bme-link-button", "<i class='icon-link'></i>", "Link - Ctrl+L", "icon-link", bindCommand(function (chunk, postProcessing) {
                return this.doLinkOrImage(chunk, postProcessing, false);
            }), group2);
            buttons.quote = makeButton("bme-quote-button", "<i class='icon-chevron-right'></i>", "Blockquote - Ctrl+Q", "icon-blockquote", bindCommand("doBlockquote"), group2);
            buttons.code = makeButton("bme-code-button", "<i class='icon-indent-right'></i>", "Code Sample - Ctrl+K", "icon-code", bindCommand("doCode"), group2);
            buttons.image = makeButton("bme-image-button", "<i class='icon-picture'></i>", "Image - Ctrl+G", "icon-picture", bindCommand(function (chunk, postProcessing) {
                return this.doLinkOrImage(chunk, postProcessing, true);
            }), group2);

            group3 = makeGroup(3);
            buttons.olist = makeButton("bme-olist-button", "<i class='icon-list-ol'></i>", "Numbered List - Ctrl+O", "icon-list", bindCommand(function (chunk, postProcessing) {
                this.doList(chunk, postProcessing, true);
            }), group3);
            buttons.ulist = makeButton("bme-ulist-button", "<i class='icon-list-ul'></i>",  "Bulleted List - Ctrl+U", "icon-bullet-list", bindCommand(function (chunk, postProcessing) {
                this.doList(chunk, postProcessing, false);
            }), group3);
            buttons.heading = makeButton("bme-heading-button", "<i class='icon-th-list'></i>", "Heading - Ctrl+H", "icon-header", bindCommand("doHeading"), group3);
            buttons.hr = makeButton("bme-hr-button", "<i class='icon-minus'></i>", "Horizontal Rule - Ctrl+R", "icon-hr-line", bindCommand("doHorizontalRule"), group3);
            
            group4 = makeGroup(4);
            buttons.undo = makeButton("bme-undo-button", "<i class='icon-undo'></i>", "Undo - Ctrl+Z", "icon-undo", null, group4);
            ...
            buttons.redo = makeButton("bme-redo-button", "<i class='icon-repeat'></i>", redoTitle, "icon-share-alt", null, group4);
